...
public class AutoMain extends SidePanel{
	...
	//	setContentView(R.layout.firstactivity_main);
		 ViewGroup content = (ViewGroup) findViewById(R.id.frame_container);
	        getLayoutInflater().inflate(R.layout.auto_main, content, true);   
	    ...
	    private class PlacesTask extends AsyncTask<String, Void, String>{
	        ...
	        protected String doInBackground(String... place) {
	            ...
	            String key = "key=AIzaSyDEpGotU_SajNrAzh9vwiaEtdZoAO9DbCk";
